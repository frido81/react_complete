export default function ShowProject({project}) {
    return (
        ...
        <div className="flex justify-between">
            <input type="text" className="w-full px-2 py-1 rounded-sm bg-stone-200" />
            <button className="text-stone-600 hover:text-stone-950 w-24">Add task</button>
        </div>

        <ul className="p-4 mt-8 rounded-md bg-stone-100">

            <div className="flex justify-between">
                <li className="flex my-4">rounded</li>
